...
public class BtnResponsabileNegozioVisualizzaOrdiniDettaglioListener implements ActionListener {

	OrdiniPrecedenti parent;
	
	public BtnResponsabileNegozioVisualizzaOrdiniDettaglioListener(OrdiniPrecedenti parent)
	{
		this.parent = parent;
	}
